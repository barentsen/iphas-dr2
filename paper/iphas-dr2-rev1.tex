...
are then progressively refined using the
Two-Micron All Sky Survey catalogue \citep[2MASS; ][]{Skrutskie2006}.
...
An external validation has been carried out
by comparing our positions against the
United States Naval Observatory CCD Astrograph Catalog 
\citep[UCAC4;][]{UCAC4}.
Fig.~\ref{fig:astrometry} shows the distribution
of the astrometric residuals
between IPHAS and UCAC4
for N million stars in the magnitude
range $13 < r < 15$,
which is the range where both surveys overlap
and where the formal mean error of UCAC4
is better than 50~mas \citep{UCAC3}.
We find the mean residual to be $0\farcs 09\pm0\farcs 07$,
which is satisfactory for our purposes.

\begin{figure}
    \includegraphics[width=0.5\textwidth]{figures/astrometry/astrometry.pdf} 
    \caption{Distribution of position residuals
            between IPHAS DR2 and UCAC4.
            The residuals were computed for stars
            in the magnitude range $13 < r < 15$ which were
            not blended and not saturated.}
