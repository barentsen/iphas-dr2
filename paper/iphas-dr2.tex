...
for all of the 2,801 quality-approved fields
...
fields which suffer from calibration errors,
which can exceed 0.1~mag or more.
For comparison, Fig.~\ref{fig:ccd_after}
shows the identical diagram
constructed after re-calibrating.
