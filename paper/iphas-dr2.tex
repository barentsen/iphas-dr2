...
is shown in Fig.~\ref{fig:density} (thick blue line).
...
In fact dark clouds are readily visible in the night sky
towards these constellations,
and they are often referred to as the `the Great Rift' \citep[e.g.][]{BokBok}.
...
In Fig.~\ref{fig:density} we also shows the density
