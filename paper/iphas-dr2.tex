...
To appraise the level at which our photometry is affected by systematics,
...
We find the mean residual to equal 0.03~mag
across the magnitude ranges 13 to 18 ($r$)
and 12 to 17 ($i$, \ha),
consistent with the accuracy of our calibration estimated earlier.
Stars fainter than this range appear to be dominated by photon noise (red line),
while stars at the bright end appear to suffer from significant systematic
...
but the number of outliers is significantly smaller
