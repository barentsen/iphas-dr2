...
Astronomy, University of Manchester, Oxford Road, Manchester M13 9PL, U.K.}
...
to infrared surveys.
We also provide images for some of the most
...
These are young objects which show \ha\ in emission
...
as Young Stellar Objects (YSO)
in an initial investigation of the region by \cite{Yu2012}.
...
four of our candidates as having
an infrared excess, we note that each of these four objects
is detected at S/N$>$? in the Spitzer 8.0\,\micron\ image,
which is consistent with an optically-unveiled Class II YSO.

%The IPHAS catalogue offers photometry
...
and plan to produce a catalogue 
