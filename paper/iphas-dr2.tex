...
% RR: better Sloan Digital Sky Survey (SDSS)?
...
% RR: The INT acronym is defined before
...
to be extended into larger, deeper, and more statistically-robust samples.
...
Fig.~\ref{fig:footprint} shows the footprint % Should replace all Figure with Fig., according to the MNRAS style I think
...
% not sure if you need the \arcsec I added, but it would look nicer to me.
...
of the Two Micron All Sky Survey \citep[][]{Nikolaev2000},
the Sloan Digital Sky Survey \citep[][]{Padmanabhan2008}
% Define both 2MASS and SDSS before in the text
...
% what's the low surface density seen at ~90 deg?
...
being optically-unveiled, or Class II, YSOs
% add e reference for the YSO classification?
...
GB, JED and SES acknowledge support from the United Kingdom Science Technology and Facilities Council (STFC, JED and GB ST/J001333/1, SES ST/K00106X/1).
