...
$^{15}$School of Physics \& Astronomy, University of Southampton, Southampton, SO17 1BJ, U.K.\\
(see the source file for affiliations 16 to 28)
%$^{16}$European Space Astronomy Centre (ESAC), Villafranca del Castillo, Villanueva de la Canada, E-28692 Madrid, Spain.\\
%$^{17}$School of Physics, Bristol University, Tyndall Avenue, Bristol, BS8 1TL, U.K.\\
...
%$^{20}$Australian Astronomical Observatory, PO Box 915, North Ryde, NSW 1670, Australia.\\
%$^{21}$Research Centre for Astronomy, Astrophysics and Astrophotonics, Macquarie University, Sydney, NSW 2109 Australia.\\
%$^{22}$Instituto de Astonom\'ia y Meteorolog\'ia, Departamento de F\'isica, CUCEI, Universidad de Guadalajara, Mexico.\\
%$^{23}$Instituut voor Sterrenkunde, K.U. Leuven, Celestijnenlaan 200D, B-3001 Leuven, Belgium.\\
%$^{24}$Max-Planck-Institut f\"ur extraterrestrische Physik (MPE), Giessenbachstrasse 1, D-85748, Garching bei M\"unchen, Germany. \\
%$^{25}$Department of Physics, Blackett Laboratory, Imperial College London, Prince Consort Road, London, SW7 2AZ, U.K.\\
%$^{26}$Centro de Estudios de F\'isica del Cosmos de Arag\'on, Plaza San Juan 1, Planta 2, Teruel, 44001, Spain. \\
%$^{27}$Armagh Observatory, College Hill, Armagh, Northern Ireland, BT61 9DG, U.K.\\
%$^{28}$Jodrell Bank Centre for Astrophysics, School of Physics \& Astronomy, University of Manchester, Manchester M13 9PL, U.K.
}
...
and longitudes $\ell=30$ to 215\degr\ 
...
the UKIDSS Galactic Plane Survey \citep[GPS;][]{Lawrence2007,Lucas2008}
and the 
