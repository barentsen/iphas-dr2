...
$^{19}$Instituut voor Sterrenkunde, K.U. Leuven, Celestijnenlaan 200D, B-3001 Leuven, Belgium\\
$^{20}$Department of Physics, Blackett Laboratory, Imperial College
London, Prince Consort Road, London, SW7 2AZ, U.K.\\
$^{21}$Centro de Estudios de F\'isica del Cosmos de Arag\'on, Plaza San Juan 1, Planta 2, Teruel, 44001, Spain. \\
$^{22}$Armagh Observatory, College Hill, Armagh, Northern Ireland,
BT61 9DG, U.K.\\
$^{23}$Jodrell Bank Centre for Astrophysics, School of Physics \&
...
catalogue's unique
$(r-\ha,\ r-i)$ colour-colour diagram to
...
is providing new insights into the contents and structure 
...
in $U$, $g$, $r$, $i$, \ha\ 
\citep{Greiss2012},
and a survey of the entire Southern Galactic Plane
in $u$, $g$, $r$, $i$, \ha\ 
...
across 360$^\circ$,
and provide images across the most crowded
regions to be faced by Gaia.
