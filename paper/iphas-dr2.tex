...
covering Galactic longitudes $l=30^\circ$ to $215^\circ$
and latitudes $b = -5^\circ$ to $+5^\circ$
...
\ha-emitters that are unveiled by IPHAS towards an H{\sc ii}
...
In their studies, the authors used Spitzer data
to select intrinsically red objects,
consistent with the presence of a circumstellar disk.
...
which is consistent with being optically-unveiled stars with a circumstellar disk,
