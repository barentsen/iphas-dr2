...
$^{10}$Th\"uringer Landessternwarte, Sternwarte 5, D-07778, Tautenburg, Germany \\
$^{11}$Observatorio Astron\'omico, Universidad de Valencia,
...
The problems affecting the 24\% falling below survey standard were,
...
e.g. 92\% of the fields at $\ell<120\degr$ are better than 1.7~arcsec.
To increase the sky area offered by the present release slightly,
...
In the $r$-band, 90\% is better than 1.5~arcsec,
...
(we adopt a 2.3~arcsec diameter circular aperture by default).
...
of Aquila ($\ell\simeq40$) and Cygnus ($\ell\simeq80$ and $\ell\simeq90$),
...
which were chosen because they show different characteristics.
...
taking in the latitude range $|b|<5\degr$.
...
BTG acknowledges funding from the European Research Council
under the European Union's Seventh Framework Programme (FP/2007-2013) 
/ ERC Grant Agreement n. 320964 (WDTracer).
