...
$^{10}$Observatorio Astr\'onomico, Universidad de Valencia,
...
$^{12}$ Joint ALMA Observatory, Alonso de Córdova 3107, Vitacura 763-0355, Santiago, Chile. \\
$^{13}$School of Physics \& Astronomy, University of Southampton, Southampton, SO17 1BJ, U.K.\\
$^{14}$European Space Astronomy Centre (ESAC), Villafranca del Castillo, Villanueva de la Canada, E-28692 Madrid, Spain.\\
$^{15}$School of Physics, Bristol University, Tyndall Avenue, Bristol, BS8 1TL, U.K.\\
$^{16}$School of Physics, University of Exeter, Stocker Road, Exeter, EX4 4QL, U.K.\\
$^{17}$Department of Physics \& Astronomy, Macquarie University, NSW 2109, Australia\\
$^{18}$Instituto de Astonom\'ia y Meteorolog\'ia, Departamento de F\'isica, CUCEI, Universidad de Guadalajara, Mexico.\\
$^{19}$Department of Physics, Blackett Laboratory, Imperial College
London, Prince Consort Road, London, SW7 2AZ, U.K.\\
$^{20}$Centro de Estudios de F\'isica del Cosmos de Arag\'on, Plaza San Juan 1, Planta 2, Teruel, 44001, Spain. \\
$^{21}$Armagh Observatory, College Hill, Armagh, Northern Ireland,
BT61 9DG, U.K.\\
$^{22}$Jodrell Bank Centre for Astrophysics, School of Physics \&
...
and to a mean depth of $r=21.2$ / $i=20.0$ / $\ha=20.3$
...
0.03~mag (rms) by validating against SDSS,
...
to infrared surveys.
IPHAS also provide images for some of the most
...
which is located $\sim$500\,metres from the INT.
...
\centering
\includegraphics[width=\textwidth]{./plots/pairmag/pairmag.pdf}
\caption{}
\label{fig:pairmag}
\end{subfigure}
\hspace{0.5cm}
\begin{subfigure}[b]{0.45\linewidth}
\centering
\includegraphics[width=\textwidth]{./plots/pairmag/pairmag-reliable.pdf}
\caption{}
...
as seen in the mid-infrared by the Spitzer Space Telescope's
Galactic Plane survey \citep[GLIMPSE;][]{Benjamin2003,Churchwell2009}.
The infrared image reveals a bubble-shaped structure
which is thought to originate from the
mid-infrared emission of Poly-Aromatic Hydrocarbons (PAHs)
-- i.e. warm dust --
...
being optically-unveiled Class II YSOs
with a mild infrared excess.
...
and can be used to discover optically-unveiled
T~Tauri stars when the extinction is sufficiently low.
...
(catalogue ID TBD; Conesearch/TAP URL TBD?).
...
were found to be accurate at the level of $0.03$ mag (rms),
...
$(r-i)$/$(r-\ha)$ diagram for characterising stellar populations
...
We also aim to correct the IPHAS photometry for the
radial field distortions,
plan to produce a catalogue 
...
and a southern survey in $u$/$g$/$r$/$i$/\ha\ 
called VPHAS+ \citep{Drew2014}.
We intend to use the present work
as a template for generating catalogues
from these companion surveys.
When combined, these surveys
will offer new insights
into the contents and structure of the Milky Way
across 360$^\circ$.
